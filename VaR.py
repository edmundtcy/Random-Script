...
def relative_VaR(s_zero, mu, sigma, T, Z, delta):
    ...
    return (expected_value_divident(s_zero, mu, T, delta) - (stochastic_model_dividend(s_zero, mu, sigma, T, Z, delta) + 0.5/52))
...
def main():
    ...
    print("The expected value of the portfolio is:", expected_value_divident(s_zero, mu, T, delta))
